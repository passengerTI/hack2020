...
for rownum in range(sheet.nrows):
  ...
  if rownum == 0:
    ...
    cursor.execute("""INSERT INTO sovershen11(id,sex,family,ethnos,national,religion,study,profession,working,pension,col11,col12,col13,col14,col15,col16,col17,col18,col19,col20,col21,col22,col23,col24,col25,col26,col27,col28,col29,col30)
